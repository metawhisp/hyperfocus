...
// MARK: V5 — the red ring ITSELF morphs into rotating particles.
// The renderer (RingToParticlesOrb) is PRODUCTION code now — see Hyperfocus/Orb/FocusOrbView.swift.
